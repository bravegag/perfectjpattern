...
// EclipseLinkDaoFactory.java Copyright (c) 2012 Giovanni Azua Garcia
...
implements IGenericDaoFactory, ISingleton
{
    ...
    //------------------------------------------------------------------------
    /**
     * Returns Singleton instance of {@link EclipseLinkDaoFactory}
     * 
     * @return Singleton instance of {@link EclipseLinkDaoFactory}
     */
    public static EclipseLinkDaoFactory
    getInstance()
    {
        if (INSTANCE == null) {
            INSTANCE = new EclipseLinkDaoFactory();            
        }
    ...
    //------------------------------------------------------------------------
    /**
     * Constructs {@link EclipseLinkDaoFactory} to consume Session instances 
     ...
     */
    protected 
    EclipseLinkDaoFactory(ISessionStrategy aSessionStrategy, 
     ...
     */
    protected
    EclipseLinkDaoFactory()
    {
        ISessionStrategy mySessionStrategy = 
            new EclipseLinkSessionStrategy();
            ...
            ITransactionStrategy aTransactionStrategy)
    {
        ...
        return new EclipseLinkGenericDao<Id, Element>(aPersistentClass, 
    ...
    // members
    //------------------------------------------------------------------------
    private static EclipseLinkDaoFactory INSTANCE = null;
}
