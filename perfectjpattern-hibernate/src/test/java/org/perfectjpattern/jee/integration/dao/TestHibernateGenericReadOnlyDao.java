...
// TestHibernateReadOnlyDao.java Copyright (c) 2012 Giovanni Azua Garcia
 ...
 */
public 
class TestHibernateGenericReadOnlyDao
extends AbstractTestGenericReadOnlyDao
{
    ...
    //------------------------------------------------------------------------
    /**
     * Default {@link TestHibernateGenericReadOnlyDao} constructor
     */
    public 
