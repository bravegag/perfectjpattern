...
/**
 * Adapter example test suite 
 * 
 * @author <a href="mailto:bravegag@hotmail.com">Giovanni Azua</a>
 * @version $Revision: 1.0 $Date: Feb 5, 2009 10:13:02 PM $
 */
public 
class TestExample
extends TestCase
{
    ...
    testAdapter()
    {
        ...
        myLoggerMock.debug("Hello");
        myLoggerMock.debug("Adapter");
        myLoggerMock.debug("[Adapter, World!]");
