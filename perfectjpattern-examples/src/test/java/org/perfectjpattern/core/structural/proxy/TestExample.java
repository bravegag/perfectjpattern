...
extends TestCase
{
    ...
    testProxy()
    {
        ...
        myLoggerMock.debug("Proxy is now loading the Image ...");
        myLoggerMock.debug("Cropping an Image");
        myLoggerMock.debug("Drawing an Image");
                        
        replay(myLoggerMock);
        
        Image.setLogger(myLoggerMock);
        ImageProxy.setLogger(myLoggerMock);
