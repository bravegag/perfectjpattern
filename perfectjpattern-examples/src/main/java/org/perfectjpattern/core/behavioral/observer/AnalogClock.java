...
/**
 * Concrete implementation of {@link IClock} of type Analog
 *
...
implements IClock
{
    ...
    draw()
    {
        ...
        theLogger.debug("Printing Analog timestamp: " + myFormat.format(
            theDate));
    }
    ...
    update(Date aDate)
    {
        theLogger.debug("Analog clock received an update event");
     ...
     */
    private static Logger theLogger = LoggerFactory.getLogger(AnalogClock.
        class);
}
