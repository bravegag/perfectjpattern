...
// ExpiredState.java Copyright (c) 2012 Giovanni Azua Garcia
...
/**
 * Concrete {@link IExpiredState} implementation. Note that this 
 * implementation will not directly implement {@link IExpiredState} 
...
implements IPurgeRequest
{
    ...
    // members
    //------------------------------------------------------------------------
    private static Logger theLogger = LoggerFactory.getLogger(ExpiredState.
        class);
}
