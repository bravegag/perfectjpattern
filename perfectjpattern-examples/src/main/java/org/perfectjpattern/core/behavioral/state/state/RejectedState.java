...
// RejectedState.java Copyright (c) 2012 Giovanni Azua Garcia
...
/**
 * Concrete {@link IRejectedState} implementation. Note that this 
 * implementation will not directly implement {@link IRejectedState} 
...
implements IPurgeRequest
{
     ...
     */
    public void 
    purge(IFXLimitOrder anFXLimitOrder)
    {
        theLogger.debug("Purging order '" + anFXLimitOrder + "'");
        
        super.next(anFXLimitOrder, IPurgeRequest.class);
    }    
        
    //------------------------------------------------------------------------
    // members
    //------------------------------------------------------------------------
    private static Logger theLogger = LoggerFactory.getLogger(RejectedState.
        class);
}
