...
// List2QueueAdapter.java Copyright (c) 2012 Giovanni Azua Garcia
...
extends Adapter<Queue<E>, List<E>>
{
    ...
    {
        super((Class<Queue<E>>) ((Class<?>) Queue.class), anAdaptee, 
            new NameMatchAdaptingStrategy(METHODS_MAPPING));
    }    
    ...
    // members
    //------------------------------------------------------------------------
    private static final Map<String, String> METHODS_MAPPING = 
