...
// TestNullParameter.java Copyright (c) 2012 Giovanni Azua Garcia
...
/**
 * Test Suite for <code>NullParameter</code> implementation.
 * 
 * @see NullParameter
 * 
...
extends AbstractTestSingleton<NullParameter> 
{
    //------------------------------------------------------------------------
    // public
    //------------------------------------------------------------------------
    ...
    TestNullParameter()
    {
        super(NullParameter.class, NullParameter.getInstance());
    }
}
